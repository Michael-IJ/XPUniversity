...
class CourseOfStudy {
    ...
    async updateCourseOfStudy(req, res) {
        try {
            ...
            res.status(200).json({ message: "Course Of Study Updated Successfully", body: updatedCourseOfStudy})
        }
        catch (error) {
...
const validate = (CourseOfStudy) => {
    ...
    if (CourseOfStudy.RequiredCreditUnit == null || CourseOfStudy.RequiredCreditUnit == undefined || CourseOfStudy.RequiredCreditUnit < 1) {
        return "RequiredCreditUnit is required. ";
    }
